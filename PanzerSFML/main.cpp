...
//TODO: Добавить карту, отрисовку карты, добавить больше объектов, перемещение и масштабирование карты, класс танка, 
//		класс игры, класс интерфейса,перемещение по клику,нарисовать больше текстур земли, декораций, текстуры интерфейса, пиксельный шрифт
